...
5.	
6.	Run this function in MATLAB to generate a batch script to run tracking on each video with the model you created in SLEAP:
...
7.	After those copy, you can use the MATLAB function “copyNewPredictions” in "make_analysis_folder_copy_files.m" to copy from the predictions folder into your folder structure.
